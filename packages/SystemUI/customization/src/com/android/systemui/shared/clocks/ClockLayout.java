...
import com.android.systemui.shared.clocks.BurnInHelperKt;
...
public class ClockLayout extends FrameLayout {
    ...
    private void positionChildren() {
        ...
        BurnInHelperKt.getBurnInOffset(mBurnInPreventionOffsetX * 2, true) - mBurnInPreventionOffsetX,
                mDarkAmount);
        final float offsetY = MathUtils.lerp(0f,
        BurnInHelperKt.getBurnInOffset(mBurnInPreventionOffsetY * 2, false)
